...
export class UserResolverBase {
  ...
  @graphql.ResolveField(() => License, {
    nullable: true,
    name: "license",
  })
  async getLicense(@graphql.Parent() parent: User): Promise<License | null> {
    const result = await this.service.getLicense(parent.id);
